...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
 ...
 function admin_tabler(){      
    ...
    $compile = '';
    if (isset($_POST['filterFaculty'])){
        $compile .= "AND faculty_id={$_POST['filterFaculty']}";
    }else if (isset($_POST['filterSubject'])){
                ...
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                  ...
                  <?php endif ?>
                    ...
                    <form id="filterFacultyOption" action="./faculty.php" method="POST">
                        <select class="filterFacultyOption" id="selectFaculty" name="filterFaculty">
                    ...
                    <form id="filterSubjectOption" action="./faculty.php" method="POST">
                        <select class="filterSubjectOption" id="selectSubject" name="filterSubject">
